...
class NewConfiguredInstanceCest
{
    ...
    /**
     * Unit Tests Phalcon\Container\Builder :: newConfiguredInstance() - object
     *
     * @since  2019-12-30
     */
    public function containerBuilderNewConfiguredInstanceObject(UnitTester $I)
    {
        $I->wantToTest('Container\Builder - newConfiguredInstance() - object');

        $classes = [
            new ConfigLibraryFixtureClass(),
