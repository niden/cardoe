...
class SendRequestCest
{
     ...
     * @since  2019-10-06
     */
    public function httpMessageClientTransportStreamSendRequest(UnitTester $I)
    {
        $I->wantToTest('Http\Message\Client\Transport\Stream - sendRequest()');
    ...
    /**
     * Tests Cardoe\Http\Client\Transport\Stream :: sendRequest() - exception
     *
     * @since  2019-10-06
     */
    public function httpMessageClientTransportStreamSendRequestException(UnitTester $I)
    {
        $I->wantToTest('Http\Message\Client\Transport\Stream - sendRequest() - exception');

        $stream    = new StreamFactory();
        $response  = new ResponseFactory();
        $transport = new Stream($stream, $response);
        $message   = "fopen(): php_network_getaddresses: "
