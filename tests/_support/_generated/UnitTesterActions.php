<?php //[STAMP] f94ae61b80713443818017734fa076be
...
trait UnitTesterActions
{
     ...
     * });
     * ```
     * If you want to check message or exception code, you can pass them with
     * exception instance:
     * ```php
     * <?php
     * // will check that exception MyException is thrown with "Don't do bad
     * things" message
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Handles and checks throwables (Exceptions/Errors) called inside the
     * callback function. Either throwable class name or throwable instance
     * should be provided.
     *
     * ```php
     * <?php
     ...
     * });
     * ```
     * If you want to check message or throwable code, you can pass them with
     * throwable instance:
     * ```php
     * <?php
     * // will check that throwable MyError is thrown with "Don't do bad
     * things" message
     ...
     * Unlike `seeInThisFile` will fail if file has something more than
     * expected lines. Better to use with HEREDOC strings. Matching is done
     * after removing "\r" chars from file content.
     *
     * ``` php
     * <?php
