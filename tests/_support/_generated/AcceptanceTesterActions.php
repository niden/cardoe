...
trait AcceptanceTesterActions
{
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Open web page at the given absolute URL and sets its hostname as the
     * base host.
     *
     * ``` php
     * <?php
     * $I->amOnUrl('http://codeception.com');
     * $I->amOnPage('/quickstart'); // moves to
     ...
     * If Codeception commands are not enough, use [Guzzle HTTP
     * Client](http://guzzlephp.org/) methods directly
     *
     * Example:
     *
     * ``` php
     ...
     * If Codeception lacks important Guzzle Client methods, implement them and
     * submit patches.
     *
     ...
     * If a fuzzy locator is given, the page will be searched for a button,
     * link, or image matching the locator string. For buttons, the "value"
     * attribute, "name" attribute, and inner text are searched. For links, the
     * link text is searched. For images, the "alt" attribute and inner text of
     * any parent links are searched.
     *
     * The second parameter is a context (CSS or XPath locator) to narrow the
     * search.
     *
     * Note that if the locator matches a button of type `submit`, the form
     * will be submitted.
     *
     * ``` php
     * <?php
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks that the current page contains the given string (case
     * insensitive).
     *
     ...
     * ``` php
     * <?php
     * $I->see('Logout');                        // I can suppose user is
     * logged in
     ...
     * ```
     *
     * Note that the search is done after stripping all HTML tags from the
     * body,
     ...
     *                               Conditional Assertion: Test won't be
     *                               stopped on fail
     *
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks that the current page doesn't contain the text specified (case
     * insensitive). Give a locator as the second parameter to match a specific
     * region.
     *
     * ```php
     * <?php
     * $I->dontSee('Login');                         // I can suppose user is
     * already logged in
     * $I->dontSee('Sign Up','h1');                  // I can suppose it's not
     * a signup page
     ...
     * Give a full URL as the second parameter to match links with that exact
     * URL.
     *
     * ``` php
     * <?php
     ...
     * If the second parameter is given, only links with a matching "href"
     ...
     * ``` php
     * <?php
     * $I->dontSeeCheckboxIsChecked('#agree'); // I suppose user didn't agree
     * to terms
     * $I->seeCheckboxIsChecked('#signup_form input[type=checkbox]'); // I
     * suppose user didn't check the first checkbox in form.
     * ?>
     * ```
     *
     * @param $checkbox
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks that the given input field or textarea *equals* (i.e. not just
     * contains) the given value. Fields are matched by label text, the "name"
     * attribute, CSS, or XPath.
     *
     * ``` php
     * <?php
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks if the array of form parameters (name => value) are set on the
     * form matched with the passed selector.
     *
     * ``` php
     * <?php
     ...
     * ```
     *
     * For multi-select elements, or to check values of multiple elements with
     * the same name, an array may be passed:
     *
     * ``` php
     * <?php
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks if the array of form parameters (name => value) are not set on
     * the form matched with the passed selector.
     *
     * ``` php
     * <?php
     ...
     * ```
     *
     * To check that an element hasn't been assigned any one of many values, an
     * array can be passed as the value:
     *
     * ``` php
     * <?php
     ...
     * differences:
     *
     *  * Only field *names* may be used, not CSS/XPath selectors nor field
     *  labels
     *  * If a field is sent to this function that does *not* exist on the
     *  page,
     *    it will silently be added to the HTTP request.  This is helpful for
     *    testing some types of forms, but be aware that you will *not* get an
     *    exception like you would if you called `fillField()` or
     *    `selectOption()` with a missing field.
     *
     * Fields that are not provided will be filled by their values from the
     * page, or from any previous calls to `fillField()`, `selectOption()` etc.
     * You don't need to click the 'Submit' button afterwards. This command
     * itself triggers the request to form's action.
     *
     ...
     * bracket characters, and must contain an array for its value.  This
     * allows
     ...
     * ```
     *
     * Or provide an associative array for the second argument to specifically
     * define which selection method should be used:
     *
     * ``` php
     * <?php
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Ticks a checkbox. For radio buttons, use the `selectOption` method
     * instead.
     *
     * ``` php
     * <?php
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Attaches a file relative to the Codeception `_data` directory to the
     * given file upload field.
     *
     * ``` php
     * <?php
     ...
     * Example:
     *
     * Imagine that by clicking checkbox you trigger ajax request which updates
     * user settings. We emulate that click by running this ajax request
     * manually.
     *
     * ``` php
     * <?php
     * $I->sendAjaxPostRequest('/updateSettings', array('notifications' =>
     * true)); // POST
     * $I->sendAjaxGetRequest('/updateSettings', array('notifications' =>
     * true)); // GET
     *
     * ```
     *
     ...
     * $value = $I->grabTextFrom('~<input value=(.*?)]~sgi'); // match with a
     * regex
     * ?>
     * ```
     *
     ...
     * You can set additional cookie params like `domain`, `path`, `expires`,
     * `secure` in array passed as last argument.
     *
     * ``` php
     * <?php
     ...
     * You can set additional cookie params like `domain`, `path` in array
     ...
     * You can set additional cookie params like `domain`, `path` as array
     * passed in last argument.
     *
     * ``` php
     * <?php
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks that there are a certain number of elements matched by the given
     * locator on the page.
     *
     * ``` php
     * <?php
     ...
     *                        Conditional Assertion: Test won't be stopped on
     *                        fail
     *
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks that response code is between a certain range. Between actually
     * means [from <= CODE <= to]
     *
     * @param $from
     * @param $to
