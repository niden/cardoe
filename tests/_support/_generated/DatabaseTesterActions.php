<?php  //[STAMP] d9b5597020fcca2ac8f69a8a409ece24
...
trait DatabaseTesterActions
{
     ...
     *
     * @return array
     * @see \Helper\Database::getDatabaseOptions()
     */
    public function getDatabaseOptions() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getDatabaseOptions', func_get_args()));
    }
     ...
     *
     * @return string
     * @see \Helper\Database::getDatabaseDsn()
     */
     ...
     *
     * @return string
     * @see \Helper\Database::getDatabaseNow()
     */
    public function getDatabaseNow($driver) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getDatabaseNow', func_get_args()));
    }
     ...
     *
     * @return string
     * @see \Helper\Database::getDatabasePassword()
     */
     ...
     *
     * @return string
     * @see \Helper\Database::getDatabaseUsername()
     */
     ...
     *
     * @return Connection
     * @see \Helper\Database::getDataMapperConnection()
     */
    public function getDataMapperConnection() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getDataMapperConnection', func_get_args()));
    }
