<?php  //[STAMP] 7ab85feec7cf37e26f4e29604bfe0bc0
...
trait IntegrationTesterActions
{
     ...
     *
     * @return int
     * @see \Helper\Integration::getNewInvoice()
     */
    public function getNewInvoice($connection, $id, $title = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getNewInvoice', func_get_args()));
    }
